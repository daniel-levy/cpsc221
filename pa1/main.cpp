...
if (expected2r == result2r) cout<< "moveBackReverse passed" << endl;
   ...
   Chain q(png1,12); // img, number of strips.
   cout<< "chain 2 made" << endl;
   
   q.roll(12);
   cout << "chain rolled" << endl;
   
   PNG result2t = q.render(12);
   PNG result2rt = q.renderBack(12);
   result2t.writeToFile("images/out-roll.png");
   result2rt.writeToFile("images/out-rollReverse.png"); 

   cout << "rolled chain rendered" << endl;
...
if (expected3r == result3r) cout<< "reverseEasyReverse passed" << endl;
   ...
   Chain f(result1,36);
   cout << "rolledasdasdchain rendered" << endl;
   g.weave(f);
   cout << "rolledasdasdchain rendered" << endl;
